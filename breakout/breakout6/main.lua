...
function love.load()
    ...
    gFrames = {
        ...
        bricks = util.generateQuadsBricks(gTextures.main),
        hearts = util.generateQuads(gTextures.hearts, 10, 9)
    }
    ...
    gStateMachine = StateMachine:new {
        ...
        serve = function () return ServeState:new() end,
        ['game-over'] = function () return GameOverState:new() end
    }
...
function renderScore(score)
    ...
    love.graphics.printf(tostring(score), VIRTUAL_WIDTH - 50, 5, 50, 'right')
end
...
function renderHealth(health)
    ...
    love.graphics.print(health, VIRTUAL_WIDTH/2, VIRTUAL_HEIGHT/2)
